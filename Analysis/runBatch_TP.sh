...
cd /nfs/dust/atlas/group/top/Nedaa_Ntuples_MM/AT-2.3.37/Analysis/
echo "Setting up ROOT"
source setupROOT.sh
echo "Running python file" 
#Data
echo "python NedaaEffFakeElec_TP.py --file ${FILE} --trigger ${TRIGGER} --jet ${JET}"
python NedaaEffFakeElec_TP.py --file ${FILE} --trigger ${TRIGGER} --jet ${JET}
