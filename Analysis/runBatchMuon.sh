...
#MC
#echo "python NedaaEffFakeMuon_MC.py --file ${FILE} --trigger ${TRIGGER} --option ${OPTION}"
#python NedaaEffFakeMuon_MC.py --file ${FILE} --trigger ${TRIGGER} --option ${OPTION} 
#Data
echo "python NedaaEffFakeMuon_Data.py --file ${FILE} --trigger ${TRIGGER} --option ${OPTION}"
python NedaaEffFakeMuon_Data.py --file ${FILE} --trigger ${TRIGGER} --option ${OPTION}
