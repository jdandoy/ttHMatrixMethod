#ifndef HistoManagerFakeSemiLeptonic_h
#define HistoManagerFakeSemiLeptonic_h
//////////////////////////////////////////////////////////////////////
// 
...
class HistoManagerFakeSemiLeptonic
{
 public:
  ...
  // constructor
  HistoManagerFakeSemiLeptonic(TObjArray *histosObj);

  // destructor
  virtual ~HistoManagerFakeSemiLeptonic();

  void DefineHistos();
  TH1F *givehFakeYield(int itype, int ilevel, int icut)      const { return hFakeYield[itype][ilevel][icut]; }
  TH1F *givehFakeYieldSqSys(int itype, int ilevel, int icut) const { return hFakeYieldSqSys[itype][ilevel][icut]; }
 
  TDirectory *dirFakeSemiLeptonic;
 ...
 private:
  ...
  ClassDef(HistoManagerFakeSemiLeptonic,1)
};

#endif // HistoManagerFakeSemiLeptonic_h
