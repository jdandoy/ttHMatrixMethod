...
void FakeSemiLeptonic::setEfficiencies()
{
  ...
  else if (m_syst=="CRreal") m_myWeight_mu->SetupWeighter( FakesWeights::MUJETS, "Fred_CRreal:NJ/NB/TR:eta:pt:jetpt:dR:dPhi", "Fred:NB/NS/TR:eta:pt:jetpt:dR:dPhi");
  ...
  else if (m_syst=="CRreal") m_myWeight_el->SetupWeighter( FakesWeights::EJETS, "Fred_CRreal:NJ/NB:eta:pt:jetpt:dR:dPhi", "Fred:NB/NS:eta:pt:jetpt:dR:dPhi");
