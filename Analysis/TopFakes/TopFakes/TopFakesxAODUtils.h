...
namespace top {
   ...
   **/
  namespace fakes {
    /** @brief calculates the jet-enrivronment-related quantities for a given electron
     ...
     *  @param dROverPtClosetJet reference to dRClosetJet/PtClosetJet
     ...
     *  @param dROverPtClosetCentralJet reference to dRClosetCentralJet/PtClosetCentralJet
     **/
    void GetClosestJet (const xAOD::Electron& el, const xAOD::JetContainer& jets,
     ...
     **/
    void GetdPhiLepMET (const xAOD::Electron& el, const xAOD::MissingET& met, float& dPhi);
     ...
     *  @param dPhi reference to the deltaPhi
     **/
    void GetdPhiLepMET (const xAOD::Muon& mu, const xAOD::MissingET& met, float& dPhi);
     ...
     **/
    void GetTrigMatchVariable(const xAOD::Electron& el, int& trigmatch);
    
    /** @brief calculates the trigger-matching variable of a muon
     *  FIXME convention could be updated with new trigger recommendations
     **/
    void GetTrigMatchVariable(const xAOD::Muon& mu, int& trigmatch);
