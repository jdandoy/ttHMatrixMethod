...
// ===============================================
void FakesWeights::SetIsRun1(bool isRun1){
  _isRun1 = isRun1;
}
...
void FakesWeights::SetupWeighter(int channel, std::string aReal, std::string aFake, std::string aReal2, std::string aFake2) {
  ...
  _mmUtil = new MatrixUtils();
      std::cout << " on est ici 0" << std::endl;
...
void FakesWeights::SetupWeighterDefault(int channel, std::string syst){
  ...
  if(channel == FakesWeights::EJETS){
    if(_syst==NONE)                           SetupWeighter( FakesWeights::EJETS, "Default:NJ/TR:eta:pt:dR",       "Default:NB/NS/TR:eta:jetpt:dPhi");
    else if(_syst==MCup   || _syst==MCupel)   SetupWeighter( FakesWeights::EJETS, "Default:NJ/TR:eta:pt:dR",       "Default_MCup:NB/NS/TR:eta:jetpt:dPhi");
    else if(_syst==MCdown || _syst==MCdownel) SetupWeighter( FakesWeights::EJETS, "Default:NJ/TR:eta:pt:dR",       "Default_MCdown:NB/NS/TR:eta:jetpt:dPhi");
    else if(_syst==CRreal || _syst==CRrealel) SetupWeighter( FakesWeights::EJETS, "Default_CRreal:NB/TR:eta:pt:dR","Default:NB/NS/TR/:eta:jetpt:dPhi");
    else if(_syst==CRfake || _syst==CRfakeel) SetupWeighter( FakesWeights::EJETS, "Default:NJ/TR:eta:pt:dR",       "Default_CRfake:NB/NS/TR:eta:jetpt:dPhi");
    else if(_syst==EffPar)                    SetupWeighter( FakesWeights::EJETS, "Default:NJ/TR:eta:pt:dR",       "Default:NB/NS/TR:eta:jetpt:dR");
  ...
  // MU + JETS
   ...
   if(_syst==NONE)                           SetupWeighter( FakesWeights::MUJETS, "Default:NJ/TR:eta:pt:dR",       "Default:NB/TR:eta:pt:dR:d0sig");
   else if(_syst==MCup   || _syst==MCupmu)   SetupWeighter( FakesWeights::MUJETS, "Default:NJ/TR:eta:pt:dR",       "Default_MCup:NB/TR:eta:pt:dR:d0sig");
   else if(_syst==MCdown || _syst==MCdownmu) SetupWeighter( FakesWeights::MUJETS, "Default:NJ/TR:eta:pt:dR",       "Default_MCdown:NB/TR:eta:pt:dR:d0sig");
   else if(_syst==CRreal || _syst==CRrealmu) SetupWeighter( FakesWeights::MUJETS, "Default_CRreal:NB/TR:eta:pt:dR","Default:NB/TR:eta:pt:dR:d0sig");
   else if(_syst==CRfake || _syst==CRfakemu) SetupWeighter( FakesWeights::MUJETS, "Default:NJ/TR:eta:pt:dR",       "Default_CRfake:NB/TR:eta:pt:dR:d0sig");
   else if(_syst==EffPar)                    SetupWeighter( FakesWeights::MUJETS, "Default:NJ/TR:eta:pt:dR",       "Default:NB/TR:eta:jetpt:dR:d0sig");
  ...
  // E E
    ...
    if(_syst==NONE)                            SetupWeighter( FakesWeights::EE, "Default:NJ/TR:eta:pt:dR",        "Default:NB/NS/TR:eta:jetpt:dR");
    else if (_syst==MCup   || _syst==MCupel)   SetupWeighter( FakesWeights::EE, "Default:NJ/TR:eta:pt:dR",        "Default_MCup:NB/NS/TR:eta:jetpt:dR");
    else if (_syst==MCdown || _syst==MCdownel) SetupWeighter( FakesWeights::EE, "Default:NJ/TR:eta:pt:dR",        "Default_MCdown:NB/NS/TR:eta:jetpt:dR");
    else if (_syst==CRreal || _syst==CRrealel) SetupWeighter( FakesWeights::EE, "Default_CRreal:NB/TR:eta:pt:dR", "Default:NB/NS/TR:eta:jetpt:dR");
    else if (_syst==CRfake || _syst==CRfakeel) SetupWeighter( FakesWeights::EE, "Default:NJ/TR:eta:pt:dR",        "Default_CRfake:NB/NS/TR:eta:jetpt:dR");
  ...
  // MU MU
    ...
    if(_syst==NONE)                            SetupWeighter( FakesWeights::MUMU, "Default:NJ/TR:eta:pt:dR",        "Default:NB/TR:eta:pt:dR:d0sig");
    else if (_syst==MCup   || _syst==MCupmu)   SetupWeighter( FakesWeights::MUMU, "Default:NJ/TR:eta:pt:dR",        "Default_MCup:NB/TR:eta:pt:dR:d0sig");
    else if (_syst==MCdown || _syst==MCdownmu) SetupWeighter( FakesWeights::MUMU, "Default:NJ/TR:eta:pt:dR",        "Default_MCdown:NB/TR:eta:pt:dR:d0sig");
    else if (_syst==CRreal || _syst==CRrealmu) SetupWeighter( FakesWeights::MUMU, "Default_CRreal:NB/TR:eta:pt:dR", "Default:NB/TR:eta:pt:dR:d0sig");
    else if (_syst==CRfake || _syst==CRfakemu) SetupWeighter( FakesWeights::MUMU, "Default:NJ/TR:eta:pt:dR",        "Default_CRfake:NB/TR:eta:pt:dR:d0sig");
    else if(_syst==EffPar) {
      std::cout << " FakesWeights::WARNING: Requested systematic "<<syst<<" is not relevant for dilepton channel - using nominal instead" << std::endl;
  ...
  // E MU
    ...
    if(_syst==NONE) {
      SetupWeighter( FakesWeights::EMU,  "Default:NJ/TR:eta:pt:dR", "Default:NB/NS/TR:eta:jetpt:dR", "Default:NJ/TR:eta:pt:dR", "Default:NB/TR:eta:pt:dR:d0sig");
    }
    else if (_syst==MCup) {
      ...
      SetupWeighter( FakesWeights::EMU,  "Default:NJ/TR:eta:pt:dR", "Default_MCup:NB/NS/TR:eta:jetpt:dR", "Default:NJ/TR:eta:pt:dR", "Default_MCup:NB/TR:eta:pt:dR:d0sig");
    }
      ...
      SetupWeighter( FakesWeights::EMU,  "Default:NJ/TR:eta:pt:dR", "Default_MCdown:NB/NS/TR:eta:jetpt:dR", "Default:NJ/TR:eta:pt:dR", "Default_MCdown:NB/TR:eta:pt:dR:d0sig");
    }
      ...
      SetupWeighter( FakesWeights::EMU,  "Default:NJ/TR:eta:pt:dR", "Default_MCup:NB/NS/TR:eta:jetpt:dR", "Default:NJ/TR:eta:pt:dR", "Default:NB/TR:eta:pt:dR:d0sig");
    }
      ...
      SetupWeighter( FakesWeights::EMU,  "Default:NJ/TR:eta:pt:dR", "Default_MCdown:NB/NS/TR:eta:jetpt:dR", "Default:NJ/TR:eta:pt:dR", "Default:NB/TR:eta:pt:dR:d0sig");
    }
      ...
      std::cout << " FakesWeights::WARNING: Please use MCup instead to get this systematic variation for both electron and muon totally correlated" << std::endl;
      SetupWeighter( FakesWeights::EMU,  "Default:NJ/TR:eta:pt:dR", "Default:NB/NS/TR:eta:jetpt:dR", "Default:NJ/TR:eta:pt:dR", "Default_MCup:NB/TR:eta:pt:dR:d0sig");
    }
      ...
      std::cout << " FakesWeights::WARNING: Please use MCdown instead to get this systematic variation for both electron and muon totally correlated" << std::endl;
      SetupWeighter( FakesWeights::EMU,  "Default:NJ/TR:eta:pt:dR", "Default:NB/NS/TR:eta:jetpt:dR", "Default:NJ/TR:eta:pt:dR", "Default_MCdown:NB/TR:eta:pt:dR:d0sig");
    }
      ...
      SetupWeighter( FakesWeights::EMU,  "Default:NJ/TR:eta:pt:dR", "Default_CRfake:NB/NS/TR:eta:jetpt:dR", "Default:NJ/TR:eta:pt:dR", "Default:NB/TR:eta:pt:dR:d0sig");
    }
    else if (_syst==CRfakemu) {
      SetupWeighter( FakesWeights::EMU,  "Default:NJ/TR:eta:pt:dR", "Default:NB/NS/TR:eta:jetpt:dR", "Default:NJ/TR:eta:pt:dR", "Default_CRfake:NB/TR:eta:pt:dR:d0sig");
    }
      ...
      SetupWeighter( FakesWeights::EMU,  "Default_CRreal:NB/TR:eta:pt:dR", "Default:NB/NS/TR:eta:jetpt:dR", "Default_CRreal:NB/TR:eta:pt:dR", "Default:NB/TR:eta:pt:dR:d0sig");
    }
      ...
      SetupWeighter( FakesWeights::EMU,  "Default_CRreal:NB/TR:eta:pt:dR", "Default:NB/NS/TR:eta:jetpt:dR", "Default:NJ/TR:eta:pt:dR", "Default:NB/TR:eta:pt:dR:d0sig");
    }
      ...
      std::cout << " FakesWeights::WARNING: Please use CRreal instead to get this systematic variation for both electron and muon totally correlated" << std::endl;
      SetupWeighter( FakesWeights::EMU,  "Default:NJ/TR:eta:pt:dR", "Default:NB/NS/TR:eta:jetpt:dR", "Default_CRreal:NB/TR:eta:pt:dR", "Default:NB/TR:eta:pt:dR:d0sig");
    }
    else if(_syst==EffPar) {
      std::cout << " FakesWeights::WARNING: Requested systematic "<<syst<<" is not relevant for dilepton channel - using nominal instead" << std::endl;
      SetupWeighterDefault(FakesWeights::EMU);
...
void FakesWeights::SetLeptonDefault(float lep_pt, float lep_eta, 
                                    ...
                                    float pTdR_lj_min, float dPhi_lnu, // NEW!!
                                    float jet_pt0, 
                                               ...
                                               int nJet_tagged, int trigger) 
{
  ...
  SetLeptonDefault(lep_pt,lep_eta,el_cl_eta,dR_lj_min,pTdR_lj_min,dPhi_lnu,
